...
- Update chef-equipe-main.component.ts and app.component.ts
- Update chef-equipe-menu-item.component.ts
...
**Migration Guide**
- Update chef-equipe-menu-item.component.ts and app.menu.component.ts.
- Update theme files and layout files.
...
* Include chef-equipe-menu-item.component.ts under app folder and define it app.module.ts with declarations property.
...
* Update chef-equipe-main.component.ts.
* Update app.menu.component.ts.
* Update theme css files.
* Update layout css files.
